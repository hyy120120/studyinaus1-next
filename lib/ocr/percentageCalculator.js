...
const detectMarksheetOrigin = (text) => {
  ...
  // Indian boards
  if (/CBSE|CENTRAL BOARD/.test(upper))                   return 'CBSE';
  if (/ICSE|ISC|COUNCIL FOR THE INDIAN/.test(upper))      return 'ICSE';
