            ...
            <div className="gsa-container py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
                <div className="md:col-span-2 space-y-4">
                    ...
                    <p className="text-white/70 max-w-md text-sm leading-relaxed">
                         ...
                         <span className="text-white font-medium">Mamta Jani</span>. We provide trusted guidance for
                         students planning to study in Australia.
                         <br />
                         From choosing the right course and university to understanding the visa process, our team
                         supports students at every step of their overseas education journey.
                         <br />
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><Link href="/book-counselling" className="hover:text-primary">Book Counselling</Link></li>
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-white/80">
                        ...
                        <li className="flex gap-2">
                            <Phone size={16} className="flex-shrink-0 mt-1.5" />
                        ...
                        <li className="flex gap-2">
                          <MapPin size={16} className="flex-shrink-0 mt-1.5" />
                            <a
                         href="https://maps.app.goo.gl/cSzUqi9wgkvHu7sM9"
                         target="_blank"
